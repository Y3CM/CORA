...
$id=$_GET["id"];
$sql=$conexion ->query("select * from entradas where id=$id");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
while ($datos=$sql->fetch_object()) {?>
            ...
            <div class="valid-tooltip">
              ...
              <div class="col-md-4 position-relative">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" name="autor" class="form-control"  aria-describedby="validationTooltipUsernamePrepend" value="<?=$datos->autor ?>" required>
              ...
              <div class="col-md-12 position-relative">
                ...
                <input type="text" name="img" class="form-control"  value="<?=$datos->imagen ?>" required>
                <div class="invalid-tooltip">
    ...
    <?php 
      include "../conexiones/conexion.php";
      include "../conexiones/mod_publicacion.php";
     ?>
  </div>
